...
public class SimpleConsumerTransaction {
        private static final Logger logger =
                        LoggerFactory.getLogger(SimpleConsumerTransaction.class);

        public static void main(String[] args) {
                final String applicationID = "SimpleConsumerTransaction";
                final String bootstrapServers = "localhost:9092,localhost:9093";
                final String groupID = "SimpleConsumerTransaction";
                final String[] sourceTopicNames = {"simpleTrx1"};
                ...
                while (true) {
                        ...
                        for (ConsumerRecord<String, String> record : records) {
                                logger.info("Transaction Message - " + record.value() + ", Topic: "
