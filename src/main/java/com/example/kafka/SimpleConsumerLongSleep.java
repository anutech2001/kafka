...
public class SimpleConsumerLongSleep {
        private static final Logger logger = LoggerFactory.getLogger(SimpleConsumerLongSleep.class);

        public static void main(String[] args) {
                final String applicationID = "SimpleConsumer";
                final String bootstrapServers = "localhost:9092,localhost:9093";
                final String groupID = "SimpleConsumerGrp";
                final String[] sourceTopicNames = {"simple"};
